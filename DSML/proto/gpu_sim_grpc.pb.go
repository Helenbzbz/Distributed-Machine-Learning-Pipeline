...
const (
	...
	GPUDevice_RunForward_FullMethodName        = "/gpu_sim.GPUDevice/RunForward"
	GPUDevice_RunBackward_FullMethodName       = "/gpu_sim.GPUDevice/RunBackward"
)
...
type GPUDeviceClient interface {
	...
	RunForward(ctx context.Context, in *RunForwardRequest, opts ...grpc.CallOption) (*RunForwardResponse, error)
	RunBackward(ctx context.Context, in *RunBackwardRequest, opts ...grpc.CallOption) (*RunBackwardResponse, error)
}
...
func (c *gPUDeviceClient) RunForward(ctx context.Context, in *RunForwardRequest, opts ...grpc.CallOption) (*RunForwardResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RunForwardResponse)
	err := c.cc.Invoke(ctx, GPUDevice_RunForward_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gPUDeviceClient) RunBackward(ctx context.Context, in *RunBackwardRequest, opts ...grpc.CallOption) (*RunBackwardResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RunBackwardResponse)
	err := c.cc.Invoke(ctx, GPUDevice_RunBackward_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GPUDeviceServer interface {
	...
	// Forward and Backward passes for training
	RunForward(context.Context, *RunForwardRequest) (*RunForwardResponse, error)
	RunBackward(context.Context, *RunBackwardRequest) (*RunBackwardResponse, error)
...
func (UnimplementedGPUDeviceServer) RunForward(context.Context, *RunForwardRequest) (*RunForwardResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RunForward not implemented")
}
func (UnimplementedGPUDeviceServer) RunBackward(context.Context, *RunBackwardRequest) (*RunBackwardResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RunBackward not implemented")
}
...
func _GPUDevice_RunForward_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RunForwardRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GPUDeviceServer).RunForward(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: GPUDevice_RunForward_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GPUDeviceServer).RunForward(ctx, req.(*RunForwardRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _GPUDevice_RunBackward_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RunBackwardRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GPUDeviceServer).RunBackward(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: GPUDevice_RunBackward_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GPUDeviceServer).RunBackward(ctx, req.(*RunBackwardRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var GPUDevice_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RunForward",
			Handler:    _GPUDevice_RunForward_Handler,
		},
		{
			MethodName: "RunBackward",
			Handler:    _GPUDevice_RunBackward_Handler,
		},
	},
